...
<div style="background-color: #E0F9DE; width: 100%; padding: 20px 0;">
    <div style="max-width: 1413px; margin: 0 auto; display: flex; justify-content: center; align-items: center;">
      <img src="assets/images/about.png" alt="Responsive Image" style="width: 60%; height: auto; object-fit: contain;">
    </div>
  </div>
...
<div style="background-color: #242424; width: 100%; padding: 20px 0;">
    <div style="max-width: 1413px; margin: 0 auto; display: flex; justify-content: center; align-items: center;">
      <img src="assets/images/developers.png" alt="Responsive Image" style="width: 60%; height: auto; object-fit: contain;">
    </div>
  </div>

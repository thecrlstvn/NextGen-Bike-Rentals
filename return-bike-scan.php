...
<head>
    ...
    <title>Return Bike Confirmation</title>
...
<div class="main-content mt-5">
    <div class="header">
        ...
        <div class="title">Return Bike Confirmation</div>
    </div>

    <div id="reader"></div>
    <div id="result">Scan a QR code to return a bike!</div>
...
<script>
    ...
    function onScanSuccess(decodedText) {
        ...
        const bookingId = decodedText.trim(); // Assuming decodedText is the booking_id
        window.location.href = `return_bike.php?booking_id=${bookingId}`;
    }
    ...
    function resetScanner() {
        document.getElementById('result').innerText = "Scan a QR code to return a bike!";
